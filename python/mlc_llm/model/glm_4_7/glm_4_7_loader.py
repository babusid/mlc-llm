"""Parameter mapping for GLM-4.7 Flash from HuggingFace formats."""
...
from .glm_4_7_model import GLM47FlashConfig, GLM47FlashForCausalLM


def huggingface(model_config: GLM47FlashConfig, quantization: Quantization) -> ExternMapping:
    """Returns a parameter mapping that maps from the names of MLC LLM parameters to
    the names of HuggingFace PyTorch parameters.

    Parameters
    ----------
    model_config : GLM47FlashConfig
        The configuration of the GLM-4.7 Flash model.
    ...
    """
    model = GLM47FlashForCausalLM(model_config)
